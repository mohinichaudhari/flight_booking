...
<%
	...
	ArrayList<FlightOpeartion> list= flightOperationService.selectAll(flightOpeartion.getTo(), flightOpeartion.getFrom());
%>
<!DOCTYPE html>
<html>
<head>
	...
	<table class="table table-striped text-light">
			...
			<tbody>
				...
				<tr style="font-size:3vh">
					...
					<td  ><%=e.getAmount()%></td>
					<td  ><h5><a href="flight_delete.jsp?flightno=<%=e.getFlightno() %>">Delete</a></h5></td>
					<td  ><h5><a href="update_form.jsp?flightno=<%=e.getFlightno()%>">Update</a></h5></td>
				</tr>
				<%
					}
				%>
